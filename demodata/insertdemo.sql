...
INSERT INTO saas_product (`id`, `slug`, `name`, `instance_prefix`, `activationurl`, `is_active`, `number_of_ports`) VALUES
	(1, 'kanboard', 'Kanboard', 'kb', 'https://kanboard.example.org/activate', 1, 0);
...
INSERT INTO saas_instance (`id`,`product_id`,`identifier`,`hostname`,`channel`,`status`,`auto_renew`,`last_interaction`,`reserved_token`,`reserved_until`,`reserved_for_user_id`,`initial_password`,`db_password`,`first_port`,`last_port`) VALUES
	(1,1,'344567','host0001','stable','active',1,NULL,NULL,NULL,NULL,'','topsecret',-1,-1),
	(2,1,'238978','host0001','stable','active',1,NULL,NULL,NULL,NULL,'','topsecret',-1,-1),
	(3,1,'785275','host0001','stable','active',1,NULL,NULL,NULL,NULL,'','topsecret',-1,-1),
	(4,1,'862344','host0001','stable','free',1,NULL,NULL,NULL,NULL,'','topsecret',-1,-1),
	(5,1,'119287','host0002','stable','active',1,NULL,NULL,NULL,NULL,'','topsecret',-1,-1),
	(6,1,'239399','host0002','stable','free',1,NULL,NULL,NULL,NULL,'','topsecret',-1,-1);
