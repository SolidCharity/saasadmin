...
INSERT INTO saas_product ("id", "slug", "name", "prefix",
    ...
    "first_page_purpose","first_page_purpose_en","first_page_purpose_de",
    ...
    '','Kanboard is useful to organize your TODO list','Mit Kanboard kannst du deine TODO Liste besser organisieren ',
    '',
    'https://kanboard.org/',
    'https://kanboard.org/',
    '','',
...
INSERT INTO saas_plan ("id","product_id","period_length_in_months","period_length_in_days","currency_code","cost_per_period","notice_period_in_days",
    ...
    "is_favourite",
    "is_public",
    "quota_app", "quota_storage","additional_storage_size","cost_for_storage",
    ...
    (2,1,12,0,'EUR',50,14,'basic',20,false,true,
        '1G','1G','25G',12,
        '','Basic','Basic',
        ...
        '','Access via automatic url','Zugriff über automatisch vergebene URL'),
    (3,1,1,0,'EUR',5,7,'mini',10,true,true,
        '1G','1G','25G',1,
        '','Mini','Mini',
        ...
        '','Regular Updates to latest release','Immer wieder Aktualisierungen auf die aktuelle Version',
        '','Access via automatic url','Zugriff über automatisch vergebene URL'),
    (4,1,12,0,'EUR',300,14,'pro',90,false,true,
        '1G','20G','50G',24,
        '','Pro','Pro',
