...
INSERT INTO "saas_product" ("id", "name", "activationurl") VALUES
	(1, "Kanboard", "https://kanboard.example.org/activate");
INSERT INTO "saas_plan" ("id","product_id","periodLengthInMonths","currencyCode","costPerPeriod","noticePeriodTypeInDays","name","language","descr_target","descr_caption","descr_1","descr_2","descr_3","descr_4") VALUES
...
INSERT INTO "saas_instance" ("id","product_id","identifier","hostname","status","auto_renew","last_interaction","reserved_token","reserved_until","reserved_for_user_id","initial_password","port") VALUES
	(1,1,'344567','host0001','active',1,NULL,NULL,NULL,NULL,'',2000),
	(2,1,'238978','host0001','active',1,NULL,NULL,NULL,NULL,'',2001),
	(3,1,'785275','host0001','active',1,NULL,NULL,NULL,NULL,'',2002),
	(4,1,'862344','host0001','free',1,NULL,NULL,NULL,NULL,'',2003),
	(5,1,'119287','host0002','active',1,NULL,NULL,NULL,NULL,'',2000),
	(6,1,'239399','host0002','free',1,NULL,NULL,NULL,NULL,'',2001);
