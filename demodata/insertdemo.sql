...
INSERT INTO saas_customer ("id","user_id","newsletter","newsletter_subscribed_on","newsletter_cancelled","language_code","verified","verification_token","verification_until","organisation_name","first_name","last_name","street","number","post_code","city","country_code","email_address","is_active") VALUES
	(1,2,true,'2021-01-01',NULL,'DE',true,'',NULL,'Kaninchenzüchter Plauen e.V.','Hans','Müller','Holzweg','3','01234','Plauen','DE','hans.mueller@example.org',true),
	(2,3,true,'2021-05-01',NULL,'DE',true,'',NULL,'Gartensparte zum Spaten','Werner','Schmidt','Am Wasser','7','01234','Plauen','DE','werner@example.org',true),
	(3,4,true,'2021-05-01',NULL,'DE',true,'',NULL,'Gartensparte Schneckenhain','Bernd','Schmitz','Am Berg','2','01234','Plauen','DE','bernd.s@example.org',true),
	(4,5,true,'2021-05-01',NULL,'DE',true,'',NULL,'Sportverein Trimm Dich','Gunter','Meier','An der Elster','22','01234','Plauen','DE','gunter.meier@example.org',true);
INSERT INTO saas_instance ("id","product_id","identifier","hostname","pacuser","channel","status","auto_renew","last_interaction","reserved_token","reserved_until","reserved_for_user_id","initial_password","db_password","first_port","last_port") VALUES
	(1,1,'344567','host0001','xyz00','stable','active',true,NULL,NULL,NULL,NULL,'','topsecret',-1,-1),
	(2,1,'238978','host0001','xyz00','stable','active',true,NULL,NULL,NULL,NULL,'','topsecret',-1,-1),
	(3,1,'785275','host0001','xyz00','stable','active',true,NULL,NULL,NULL,NULL,'','topsecret',-1,-1),
	(4,1,'862344','host0001','xyz00','stable','free',true,NULL,NULL,NULL,NULL,'','topsecret',-1,-1),
	(5,1,'119287','host0002','xyz01','stable','active',true,NULL,NULL,NULL,NULL,'','topsecret',-1,-1),
	(6,1,'239399','host0002','xyz01','stable','free',true,NULL,NULL,NULL,NULL,'','topsecret',-1,-1);
