...
POFILES := apps/api/locale/de/LC_MESSAGES/django.po apps/admin/locale/de/LC_MESSAGES/django.po apps/core/locale/de/LC_MESSAGES/django.po apps/customer/locale/de/LC_MESSAGES/django.po locale/de/LC_MESSAGES/django.po
...
translate:
	...
	${VENV} cd apps/admin && django-admin compilemessages || exit -1
