...
class InstanceSerializer(serializers.HyperlinkedModelSerializer):
    ...
    class Meta:
        model = SaasInstance
        fields = ('identifier', 'hostname', 'pacuser', 'activation_token', 'db_password', 'initial_password', 'first_port', 'last_port', 'status', 'instance_url', 'prefix', 'password1', 'password2', 'django_secret_key', 'quota_storage', 'quota_app', 'custom_domain', 'dbms_type')
